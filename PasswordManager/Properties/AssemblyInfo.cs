...
[assembly: AssemblyDescription("Password Manager is a software that allows easy control and saving of all the passwords of the various accounts in an easy and secure way, without the use of external clouds. All passwords will in fact be saved to a file (.pskm) encrypted")]
